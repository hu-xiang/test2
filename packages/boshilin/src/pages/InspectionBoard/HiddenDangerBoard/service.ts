...
// 地图详情
export async function getAcciData(param: Record<string, string>) {
  return request(`/${route_url}/accident/mapList`, {
    method: 'get',
    params: param,
  });
}
...
// 事故详情
export async function getAccidentInfo(param: Record<string, string>) {
  return request(`/${route_url}/accident/editShow`, {
    method: 'get',
    params: param,
  });
}
