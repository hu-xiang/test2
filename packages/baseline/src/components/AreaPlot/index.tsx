 ...
 * @Last Modified by: wf
 * @Last Modified time: 2022-12-02 18:04:40
...
const AreaPlot: React.FC<Iprop> = memo((props) => {
  ...
  const lineColors = lineColorData || [
    'rgba(55, 87, 255, 1)',
    'rgba(36, 174, 74, 1)',
    'rgba(171, 201, 231, 1)',
  ];
  ...
  const config: any = {
    ...
    yAxis: {
      ...
      grid: {
        line: {
          style: { stroke: isBlack ? '#636467' : 'rgba(204, 204, 204, 0.6)', lineDash: [6, 3] },
        },
      },
    },
    tooltip: isBlack
