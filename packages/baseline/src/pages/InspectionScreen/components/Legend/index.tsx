...
import carSvg from '../../../../../public/images/map-car.svg';
import trailSvg from '../../../../../public/images/trail.svg';
import carOfflineSvg from '../../../../../public/images/map-car-offline.svg';
          ...
          <div>
            <div className={styles.numNum}>
              <EllipsisTooltip title={'病害标记'}>
                <img src={pointSvg} width="20.75" height="24.09" /> 病害标记
              </EllipsisTooltip>
            </div>
            <div className={styles.numNum}>
              <EllipsisTooltip title={'地图落点'}>
                <img src={carSvg} width="21.75" height="24" /> 在线车辆
              </EllipsisTooltip>
            </div>
            <div className={styles.numNum}>
              <EllipsisTooltip title={'巡检轨迹'}>
                <img src={trailSvg} width="21.6" height="8.94" /> 巡检轨迹
              </EllipsisTooltip>
            </div>
            <div className={styles.numNum}>
              <EllipsisTooltip title={'离线车辆'}>
                <img src={carOfflineSvg} width="20.79" /> 离线车辆
              </EllipsisTooltip>
            </div>
          </div>
        </Col>
