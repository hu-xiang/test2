...
import { Input, Select, Button, Space, message, Modal, DatePicker } from 'antd';
...
export default (): React.ReactElement => {
  ...
  return (
    <div id={styles.container}>
      <div className={` ${styles.topSelect} topSelect`}>
      ...
      <div className={`${styles.tabBox} ${isExist() ? null : `${styles.tabBox1}`}`}>
      ...
      {/* {  ? (
        <FacModal
          ...
          isEdit={isEdit}
           workOrderAddOrEditVisible={ workOrderAddOrEditVisible}
          editInfo={editInfo}
          onCancel={() => {
            setIsEdit(false);
