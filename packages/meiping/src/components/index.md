...
import Footer from 'baseline/src/components/Footer';
...
import HeaderDropdown from 'baseline/src/components/HeaderDropdown';
...
import { Button, Menu } from 'antd';
import React from 'react';
import HeaderSearch from 'baseline/src/components/HeaderSearch';
...
import React from 'react';
import NoticeIcon from 'baseline/src/components/NoticeIcon/NoticeIcon';
